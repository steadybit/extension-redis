...
| `$ make container` | Build the container image (`extension-redis:latest`) using Docker buildx.                             |
...
## Releasing Helm Chart Changes
 ...
 1. Update the version number in the [Chart.yaml](./charts/steadybit-extension-redis/Chart.yaml)
...
```
> Releasing charts...
    Error: error creating GitHub release steadybit-extension-redis-1.0.0: POST https://api.github.com/repos/steadybit/extension-redis/releases: 422 Validation Failed [{Resource:Release Field:tag_name Code:already_exists Message:}]
```
